...
let arrayOriginal01 = ["hola", "mundo", "javascript"];
let arrayEnMayusculas = convertirAMayusculas(arrayOriginal01);
...
let numeroXX = 10;
let arrayMayoresQueX = filtrarNumerosMayoresQueX(arrayOriginal, numeroXX);
...
for(let i = 0; i<n6 ; i++){
    parseInt(arrayOriginal33.push(prompt(`Digita el elemento [${i+1}] de tu array`)))
}
...
let arraySumado = sumarUno(arrayOriginal33);

console.log(arrayOriginal33)
