...
a = 10
b=12
(a>b ? console.log("verdad") : console.log("mentira"))
...
numeroUsuario = prompt("ingresa tu numero favorito: ")
console.log("tu numero es: "+ numeroUsuario)
...
console.log(`Hola ${nombreUsuario} como estas,bienvenido`)
